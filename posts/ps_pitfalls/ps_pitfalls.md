...
## В PowerShell порядок операндов в условиях может иметь значение ##
...
![Ast дерево](https://habrastorage.org/getpro/habr/upload_files/177/5ad/800/1775ad80076c16421978647015f43f99.PNG)
...
Microsoft в своей [документации](https://learn.microsoft.com/ru-ru/powershell/scripting/dev-cross-plat/performance/script-authoring-considerations?view=powershell-5.1) для повышения производительности скриптов PowerShell при работе со строками рекомендует использовать 2 подхода:
